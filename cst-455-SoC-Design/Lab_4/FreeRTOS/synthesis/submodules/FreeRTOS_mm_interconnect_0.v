...
module FreeRTOS_mm_interconnect_0 (
	...
	wire  [104:0] freertosnios_debug_mem_slave_agent_rf_source_data;                                  // FreeRTOSNios_debug_mem_slave_agent:rf_source_data -> FreeRTOSNios_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [104:0] freertosnios_debug_mem_slave_agent_rsp_fifo_out_data;                               // FreeRTOSNios_debug_mem_slave_agent_rsp_fifo:out_data -> FreeRTOSNios_debug_mem_slave_agent:rf_sink_data
	...
	wire          cmd_mux_001_src_valid;                                                              // cmd_mux_001:src_valid -> FreeRTOSNios_debug_mem_slave_agent:cp_valid
	wire  [103:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> FreeRTOSNios_debug_mem_slave_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                              // FreeRTOSNios_debug_mem_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [5:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> FreeRTOSNios_debug_mem_slave_agent:cp_channel
	wire          cmd_mux_001_src_startofpacket;                                                      // cmd_mux_001:src_startofpacket -> FreeRTOSNios_debug_mem_slave_agent:cp_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                                        // cmd_mux_001:src_endofpacket -> FreeRTOSNios_debug_mem_slave_agent:cp_endofpacket
	...
	wire          cmd_mux_003_src_valid;                                                              // cmd_mux_003:src_valid -> sys_clk_s1_agent:cp_valid
	wire  [103:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> sys_clk_s1_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                              // sys_clk_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [5:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> sys_clk_s1_agent:cp_channel
	wire          cmd_mux_003_src_startofpacket;                                                      // cmd_mux_003:src_startofpacket -> sys_clk_s1_agent:cp_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                                        // cmd_mux_003:src_endofpacket -> sys_clk_s1_agent:cp_endofpacket
	...
	wire  [104:0] leds_s1_agent_rf_source_data;                                                       // LEDs_s1_agent:rf_source_data -> LEDs_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] leds_s1_agent_rsp_fifo_out_data;                                                    // LEDs_s1_agent_rsp_fifo:out_data -> LEDs_s1_agent:rf_sink_data
	...
	wire  [103:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> LEDs_s1_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                              // LEDs_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire    [5:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> LEDs_s1_agent:cp_channel
	...
	wire  [104:0] keys_s1_agent_rf_source_data;                                                       // KEYs_s1_agent:rf_source_data -> KEYs_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] keys_s1_agent_rsp_fifo_out_data;                                                    // KEYs_s1_agent_rsp_fifo:out_data -> KEYs_s1_agent:rf_sink_data
	...
	wire  [103:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> KEYs_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                              // KEYs_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [5:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> KEYs_s1_agent:cp_channel
	...
	wire  [103:0] freertosnios_data_master_agent_cp_data;                                             // FreeRTOSNios_data_master_agent:cp_data -> router:sink_data
	...
	wire  [103:0] freertosnios_instruction_master_agent_cp_data;                                      // FreeRTOSNios_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire          freertosnios_debug_mem_slave_agent_rp_valid;                                        // FreeRTOSNios_debug_mem_slave_agent:rp_valid -> router_003:sink_valid
	wire  [103:0] freertosnios_debug_mem_slave_agent_rp_data;                                         // FreeRTOSNios_debug_mem_slave_agent:rp_data -> router_003:sink_data
	wire          freertosnios_debug_mem_slave_agent_rp_ready;                                        // router_003:sink_ready -> FreeRTOSNios_debug_mem_slave_agent:rp_ready
	wire          freertosnios_debug_mem_slave_agent_rp_startofpacket;                                // FreeRTOSNios_debug_mem_slave_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          freertosnios_debug_mem_slave_agent_rp_endofpacket;                                  // FreeRTOSNios_debug_mem_slave_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire   [85:0] sdram_s1_agent_rp_data;                                                             // sdram_s1_agent:rp_data -> router_004:sink_data
	...
	wire          sys_clk_s1_agent_rp_valid;                                                          // sys_clk_s1_agent:rp_valid -> router_005:sink_valid
	wire  [103:0] sys_clk_s1_agent_rp_data;                                                           // sys_clk_s1_agent:rp_data -> router_005:sink_data
	wire          sys_clk_s1_agent_rp_ready;                                                          // router_005:sink_ready -> sys_clk_s1_agent:rp_ready
	wire          sys_clk_s1_agent_rp_startofpacket;                                                  // sys_clk_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          sys_clk_s1_agent_rp_endofpacket;                                                    // sys_clk_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire  [103:0] leds_s1_agent_rp_data;                                                              // LEDs_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [103:0] keys_s1_agent_rp_data;                                                              // KEYs_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [103:0] router_src_data;                                                                    // router:src_data -> FreeRTOSNios_data_master_limiter:cmd_sink_data
	wire          router_src_ready;                                                                   // FreeRTOSNios_data_master_limiter:cmd_sink_ready -> router:src_ready
	wire    [5:0] router_src_channel;                                                                 // router:src_channel -> FreeRTOSNios_data_master_limiter:cmd_sink_channel
	...
	wire  [103:0] freertosnios_data_master_limiter_cmd_src_data;                                      // FreeRTOSNios_data_master_limiter:cmd_src_data -> cmd_demux:sink_data
	wire          freertosnios_data_master_limiter_cmd_src_ready;                                     // cmd_demux:sink_ready -> FreeRTOSNios_data_master_limiter:cmd_src_ready
	wire    [5:0] freertosnios_data_master_limiter_cmd_src_channel;                                   // FreeRTOSNios_data_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire  [103:0] rsp_mux_src_data;                                                                   // rsp_mux:src_data -> FreeRTOSNios_data_master_limiter:rsp_sink_data
	wire          rsp_mux_src_ready;                                                                  // FreeRTOSNios_data_master_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire    [5:0] rsp_mux_src_channel;                                                                // rsp_mux:src_channel -> FreeRTOSNios_data_master_limiter:rsp_sink_channel
	...
	wire  [103:0] freertosnios_data_master_limiter_rsp_src_data;                                      // FreeRTOSNios_data_master_limiter:rsp_src_data -> FreeRTOSNios_data_master_agent:rp_data
	...
	wire    [5:0] freertosnios_data_master_limiter_rsp_src_channel;                                   // FreeRTOSNios_data_master_limiter:rsp_src_channel -> FreeRTOSNios_data_master_agent:rp_channel
	...
	wire  [103:0] router_001_src_data;                                                                // router_001:src_data -> FreeRTOSNios_instruction_master_limiter:cmd_sink_data
	wire          router_001_src_ready;                                                               // FreeRTOSNios_instruction_master_limiter:cmd_sink_ready -> router_001:src_ready
	wire    [5:0] router_001_src_channel;                                                             // router_001:src_channel -> FreeRTOSNios_instruction_master_limiter:cmd_sink_channel
	...
	wire  [103:0] freertosnios_instruction_master_limiter_cmd_src_data;                               // FreeRTOSNios_instruction_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire    [5:0] freertosnios_instruction_master_limiter_cmd_src_channel;                            // FreeRTOSNios_instruction_master_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire  [103:0] rsp_mux_001_src_data;                                                               // rsp_mux_001:src_data -> FreeRTOSNios_instruction_master_limiter:rsp_sink_data
	wire          rsp_mux_001_src_ready;                                                              // FreeRTOSNios_instruction_master_limiter:rsp_sink_ready -> rsp_mux_001:src_ready
	wire    [5:0] rsp_mux_001_src_channel;                                                            // rsp_mux_001:src_channel -> FreeRTOSNios_instruction_master_limiter:rsp_sink_channel
	...
	wire  [103:0] freertosnios_instruction_master_limiter_rsp_src_data;                               // FreeRTOSNios_instruction_master_limiter:rsp_src_data -> FreeRTOSNios_instruction_master_agent:rp_data
	...
	wire    [5:0] freertosnios_instruction_master_limiter_rsp_src_channel;                            // FreeRTOSNios_instruction_master_limiter:rsp_src_channel -> FreeRTOSNios_instruction_master_agent:rp_channel
	...
	wire   [85:0] router_004_src_data;                                                                // router_004:src_data -> sdram_s1_rsp_width_adapter:in_data
	wire          router_004_src_ready;                                                               // sdram_s1_rsp_width_adapter:in_ready -> router_004:src_ready
	wire    [5:0] router_004_src_channel;                                                             // router_004:src_channel -> sdram_s1_rsp_width_adapter:in_channel
	...
	wire          sdram_s1_rsp_width_adapter_src_valid;                                               // sdram_s1_rsp_width_adapter:out_valid -> rsp_demux_002:sink_valid
	wire  [103:0] sdram_s1_rsp_width_adapter_src_data;                                                // sdram_s1_rsp_width_adapter:out_data -> rsp_demux_002:sink_data
	wire          sdram_s1_rsp_width_adapter_src_ready;                                               // rsp_demux_002:sink_ready -> sdram_s1_rsp_width_adapter:out_ready
	wire    [5:0] sdram_s1_rsp_width_adapter_src_channel;                                             // sdram_s1_rsp_width_adapter:out_channel -> rsp_demux_002:sink_channel
	wire          sdram_s1_rsp_width_adapter_src_startofpacket;                                       // sdram_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_002:sink_startofpacket
	wire          sdram_s1_rsp_width_adapter_src_endofpacket;                                         // sdram_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_002:sink_endofpacket
	wire          cmd_mux_002_src_valid;                                                              // cmd_mux_002:src_valid -> sdram_s1_cmd_width_adapter:in_valid
	wire  [103:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> sdram_s1_cmd_width_adapter:in_data
	wire          cmd_mux_002_src_ready;                                                              // sdram_s1_cmd_width_adapter:in_ready -> cmd_mux_002:src_ready
	wire    [5:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> sdram_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_002_src_startofpacket;                                                      // cmd_mux_002:src_startofpacket -> sdram_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                                        // cmd_mux_002:src_endofpacket -> sdram_s1_cmd_width_adapter:in_endofpacket
	...
	wire    [5:0] freertosnios_data_master_limiter_cmd_valid_data;                                    // FreeRTOSNios_data_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire    [5:0] freertosnios_instruction_master_limiter_cmd_valid_data;                             // FreeRTOSNios_instruction_master_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	...
	wire          freertosnios_debug_mem_slave_agent_rdata_fifo_src_valid;                            // FreeRTOSNios_debug_mem_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] freertosnios_debug_mem_slave_agent_rdata_fifo_src_data;                             // FreeRTOSNios_debug_mem_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire          freertosnios_debug_mem_slave_agent_rdata_fifo_src_ready;                            // avalon_st_adapter_001:in_0_ready -> FreeRTOSNios_debug_mem_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_001_out_0_valid;                                                  // avalon_st_adapter_001:out_0_valid -> FreeRTOSNios_debug_mem_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                                                   // avalon_st_adapter_001:out_0_data -> FreeRTOSNios_debug_mem_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                                                  // FreeRTOSNios_debug_mem_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                                                  // avalon_st_adapter_001:out_0_error -> FreeRTOSNios_debug_mem_slave_agent:rdata_fifo_sink_error
	...
	wire          sys_clk_s1_agent_rdata_fifo_src_valid;                                              // sys_clk_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] sys_clk_s1_agent_rdata_fifo_src_data;                                               // sys_clk_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire          sys_clk_s1_agent_rdata_fifo_src_ready;                                              // avalon_st_adapter_003:in_0_ready -> sys_clk_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_003_out_0_valid;                                                  // avalon_st_adapter_003:out_0_valid -> sys_clk_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_003_out_0_data;                                                   // avalon_st_adapter_003:out_0_data -> sys_clk_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_003_out_0_ready;                                                  // sys_clk_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire    [0:0] avalon_st_adapter_003_out_0_error;                                                  // avalon_st_adapter_003:out_0_error -> sys_clk_s1_agent:rdata_fifo_sink_error
	...
	FreeRTOS_mm_interconnect_0_router_003 router_003 (
	...
	FreeRTOS_mm_interconnect_0_router_004 router_004 (
	...
	FreeRTOS_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clock_sys_clk_clk),                              //       clk.clk
		.reset               (FreeRTOSNios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	FreeRTOS_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clock_sys_clk_clk),                              //       clk.clk
		.reset               (FreeRTOSNios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	FreeRTOS_mm_interconnect_0_rsp_demux_001 rsp_demux_001 (
		.clk                (clock_sys_clk_clk),                              //       clk.clk
		.reset              (FreeRTOSNios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	FreeRTOS_mm_interconnect_0_rsp_demux_001 rsp_demux_002 (
		.clk                (clock_sys_clk_clk),                              //       clk.clk
		.reset              (FreeRTOSNios_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	FreeRTOS_mm_interconnect_0_avalon_st_adapter_002 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
